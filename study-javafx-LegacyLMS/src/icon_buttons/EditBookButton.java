...
public class EditBookButton extends Button implements GeneralButton {
	private static final String PATH = "file:./icons/EditBook.png";
...

	{
		...
		Tooltip tooltip = new Tooltip("Edit Book");
	...
	public EditBookButton(BookWorkSpace bookWorkSpace) {
	...
	public void buttonPressed() {
		setOnAction(e -> {
			...
			EditBookDialog editBookDialog = new EditBookDialog(bookWorkSpace);
