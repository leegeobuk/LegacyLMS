...
import dialogs.SearchBookDialog;
...
public class SearchBookButton extends Button implements GeneralButton {
	private static final String PATH = "file:./icons/SearchBook.png";
	private BookWorkSpace bookWorkSpace;
	
	public SearchBookButton(BookWorkSpace bookWorkSpace) {
		Image image = new Image(PATH, 24, 24, true, true);
		ImageView iv = new ImageView(image);
		iv.setEffect(new Glow(0.5));
		Tooltip tooltip = new Tooltip("Search Book");
	...
	public void buttonPressed() {
		setOnAction(e -> {
			System.out.println("Search book button pressed!");
			SearchBookDialog searchBookDialog = new SearchBookDialog(bookWorkSpace);
